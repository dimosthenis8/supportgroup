...
FROM DayAheadTotalLoadForecast, AreaTypeCode, MapCode, ResolutionCode, ActualTotalLoad
WHERE AreaTypeCode.Id = DayAheadTotalLoadForecast.AreaTypeCodeId AND AreaTypeCode.Id = ActualTotalLoad.AreaTypeCodeId AND MapCode.Id = DayAheadTotalLoadForecast.MapCodeId AND MapCode.Id = ActualTotalLoad.MapCodeId AND ResolutionCode.Id = DayAheadTotalLoadForecast.ResolutionCodeId AND ResolutionCode.Id = ActualTotalLoad.ResolutionCodeId AND ActualTotalLoad.AreaName = 'Slovakia' AND ResolutionCodeText='PT60M' AND ActualTotalLoad.Year = 2018 AND ActualTotalLoad.Month=1 AND ActualTotalLoad.Day=8;
*/